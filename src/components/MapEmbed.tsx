...
export const MapEmbed = ({ className = "" }: MapEmbedProps) => {
  ...
  }, [destinations, mapLoaded, moments]);
  ...
  const addDestinationsToMap = (map: mapboxgl.Map, destinations: Destination[]) => {
    ...
    // Add route line - handle antimeridian crossing for Pacific routes
    ...
    if (moments && moments.length > 0) {
      ...
      map.addLayer({
        id: "visited-places-dots",
        type: "circle",
        source: "visited-places",
        paint: {
          "circle-radius": 3,
          "circle-color": "#fb923c", // Orange-400 for organic moments
          "circle-opacity": 0.6,
          "circle-stroke-width": 0
        }
      }, "destinations-embed-past"); // Below destinations
    }
